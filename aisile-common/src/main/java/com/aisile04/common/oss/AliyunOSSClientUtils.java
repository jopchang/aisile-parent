package com.aisile04.common.oss;
...
public class AliyunOSSClientUtils {
	...
	// accessKey
		private String accessKeyId = "LTAI4FwZ3Kr38up1wmztNbEL";
	private String accessKeySecret = "MTXE980ZsKzPjyQKnVmSG7iQCe7JHf";
	// 空间
	private String bucketName = "caisile";
	// 文件存储目录
	private String filedir = "date/";
